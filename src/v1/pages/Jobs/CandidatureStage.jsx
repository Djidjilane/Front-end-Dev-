  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post(
        `/stagiaire/postulerStage/${offreId}`,
        formData,
        {
          headers: {
      ...
      setShowModal(true);
      setForm({ cip: null, cv: null, diplome: null, lettre_motivation:null });
      setFilePreviews({ cip: null, cv: null, diplome: null , lettre_motivation: null});
    } catch (error) {
      console.error(error);
                ...
                <div className="text-center">
                  ...
                  <div className="mt-5">
                    <button
                      onClick={() => {
                        setShowModal(false);
                        navigate("/stagiaire/candidature");
                      }}
...
<FileUpload 
              ...
              accept=".pdf,.jpg,.png"
              onChange={handleChange}
              preview={filePreviews.lettre_motivation}
